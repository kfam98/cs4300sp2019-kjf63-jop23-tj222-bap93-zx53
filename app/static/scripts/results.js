  ...
  $.getJSON("/static/data/pokemon_stats.json", function(json) {
    ...
    $('.ptooltip').hover( function() {
      ...
      var str = '<h4 style="margin-left:-1%;margin-top:2%;padding-top:0 !important;padding-bottom:0 !important;">Stats Breakdown</h4><div class="stats-names"> </span><span class="stats-name">HP: </span> <br/><span class="stats-name">ATTACK: </span><br/><span class="stats-name">DEFENSE: </span> <br/><span class="stats-name">SPEED: </span><br/><span class="stats-name">SP ATTACK: </span><br/><span class="stats-name">SP DEFENSE: </span></br></div>';
