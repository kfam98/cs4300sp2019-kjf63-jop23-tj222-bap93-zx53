/*
pokemonsearch.json -- contains initializers to filters on index.html
by reading in our dataset and implement UI interface
*/
  ...
  $.getJSON("/static/data/pokemondata4.json", function(json_2) {
    $.getJSON("/static/data/pokemondata3.json", function(json_3) {
      ...
      function formatCard(i) {
        ...
        //html for formating a pokemon card
        var $card = $(
    ...
    function getDataList() {
      ...
      //when adding a pokemon onto team
